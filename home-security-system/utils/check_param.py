...
def verify_motion_args(vid_stream, vid_index, q, threshold_val, min_contour_area, frame_padding, update_init_thres):
    ...
    if not isinstance(q, queues.Queue):
        raise TypeError("The queue argument should be of type multiprocessing.Queue")
...
# TODO remove if not implementing video_stream.py
